...
description or a removed dead link is worth as much as a new tool.

## What qualifies

A tool is a good fit when most of these are true:

- It helps a student do the work rather than skip it.
- It is affordable on a student budget: a real free tier, a student plan, or an open-source licence.
- It is bought and used by students, not sold to institutions about students.
...
- Homework answer services, question banks, and paper mills.
- Essay writers, and anything sold on the promise of a finished assignment.
- AI-content detectors and proctoring platforms.
- Tools with no free tier, no student plan, and no open-source licence.
- Developer tooling, which belongs in `awesome-ai-tools-for-developers`.
...
one tool added, or one category corrected, or one batch of dead links removed.
...
```md
- **[Tool Name](https://example.com/)** — What it does, in one sentence. `Freemium` `Web`
```
...
9. **One category per tool.** Pick the primary use case. Cross-listing the same
...
Submitting a tool does not guarantee it will be listed. It can be declined
